...
import com.zortek.domain.Recipe;
import com.zortek.repository.RecipeRepository;
...
/**
 * REST controller for managing {@link com.zortek.domain.Recipe}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class RecipeResource {
    ...
    public ResponseEntity<Recipe> getAllRecipes() {
        ...
        final List<Recipe> recipes = recipeRepository.findAllWithEagerRelationships(Pageable.unpaged()).getContent();
        Random rand = new Random();
        return ResponseEntity.ok().body(recipes.get(rand.nextInt(recipes.size())));
    }
}
